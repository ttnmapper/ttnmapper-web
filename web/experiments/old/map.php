...
// {
    ...
    foreach($stmt->fetchAll() as $k=>$v) {
      ...
      if(isset($gateways[$v['gwaddr']]))
      {
        ...
        if(isset($_REQUEST["lines"]) and ($_REQUEST["lines"] == "off" or $_REQUEST["lines"] == "0") ) {
          // Not drawing lines
          echo "// not drawing lines";
        } else {
          echo '
          lineOptions = {
              radius: 10,
      ...
      if(isset($_REQUEST["points"]) and ($_REQUEST["points"] == "off" or $_REQUEST["points"] == "0") ) {
        // Not drawing points
        echo "// not drawing points";
      } else {
        echo '
        markerOptions = {
            stroke: false,
    ...
    if(isset($_REQUEST["gateways"]) and ($_REQUEST["gateways"] == "off" or $_REQUEST["gateways"] == "0") ) {
      // Not drawing gateways
      echo "// not drawing gateways";
    } else {
